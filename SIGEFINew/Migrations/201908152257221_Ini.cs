    ...
    public partial class Ini : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                .ForeignKey("dbo.Proyectoes", t => new { t.ID_INSTITUCION, t.SUBP_CODIGO, t.PROG_CODIGO, t.PROY_CODIGO }, cascadeDelete: true)
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.SubProgramas", t => new { t.ID_INSTITUCION, t.SUBP_CODIGO, t.PROG_CODIGO }, cascadeDelete: true)
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.POA_PLAN", t => new { t.ID_INSTITUCION, t.PERI_CODIGO, t.COD_PLAN, t.ORG_CODIGO }, cascadeDelete: true)
                .ForeignKey("dbo.POA_TIPOPROYECTOS", t => new { t.ID_INSTITUCION, t.COD_TIPOPROY }, cascadeDelete: true)
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.RP_CARGOS", t => new { t.ID_INSTITUCION, t.ID_CARGO }, cascadeDelete: true)
                .ForeignKey("dbo.RP_RELACIONLABORAL", t => t.ID_RELALABORAL, cascadeDelete: true)
                .ForeignKey("dbo.RP_TIPOROL", t => new { t.ID_INSTITUCION, t.ID_TIPOROL }, cascadeDelete: true)
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.Actividads", t => new { t.ID_INSTITUCION, t.SUBP_CODIGO, t.PROG_CODIGO, t.PROY_CODIGO, t.ACTI_CODIGO }, cascadeDelete: true)
                .ForeignKey("dbo.Grupoes", t => new { t.ID_INSTITUCION, t.GRUP_CODIGO }, cascadeDelete: true)
                .ForeignKey("dbo.Instituciones", t => t.ID_INSTITUCION, cascadeDelete: true)
                .ForeignKey("dbo.Programas", t => new { t.ID_INSTITUCION, t.PROG_CODIGO }, cascadeDelete: true)
                .ForeignKey("dbo.Proyectoes", t => new { t.ID_INSTITUCION, t.SUBP_CODIGO, t.PROG_CODIGO, t.PROY_CODIGO }, cascadeDelete: true)
