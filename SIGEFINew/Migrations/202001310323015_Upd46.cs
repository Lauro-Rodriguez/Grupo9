namespace SIGEFINew.Migrations
{
    ...
    public partial class Upd46 : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            CreateIndex("dbo.RP_RECEPFONDOS", "ID_PORCENT");
            CreateIndex("dbo.RP_PORCAPORTACION", "ID_TIPOSEGURO");
            CreateIndex("dbo.RP_CUOTASANTICIPO", new[] { "ID_INSTITUCION", "NUM_ANTICIPO", "ID_EMPLEADO", "ID_TIPOANTICIPO" });
            CreateIndex("dbo.RP_ANTICIPOS", new[] { "ID_INSTITUCION", "ID_TIPOANTICIPO" });
            CreateIndex("dbo.RP_ABONOS", new[] { "ID_INSTITUCION", "NUM_ANTICIPO", "ID_EMPLEADO", "ID_TIPOANTICIPO" });
            CreateIndex("dbo.RP_TIPOSANTICIPO", "ID_INSTITUCION");
            CreateIndex("dbo.RP_RUBROS", new[] { "ID_INSTITUCION", "ID_TIPOROL" });
            CreateIndex("dbo.RP_DETALLEROL", new[] { "ID_INSTITUCION", "COD_RUBRO" });
            CreateIndex("dbo.RP_DETALLEROL", new[] { "ID_INSTITUCION", "ID_EMPLEADO" });
            AddForeignKey("dbo.RP_PORCAPORTACION", "ID_TIPOSEGURO", "dbo.RP_TIPOSEGURO", "ID_TIPOSEGURO", cascadeDelete: true);
            AddForeignKey("dbo.RP_RECEPFONDOS", "ID_PORCENT", "dbo.RP_PORCAPORTACION", "ID_PORCENT", cascadeDelete: true);
            AddForeignKey("dbo.RP_ANTICIPOS", new[] { "ID_INSTITUCION", "ID_TIPOANTICIPO" }, "dbo.RP_TIPOSANTICIPO", new[] { "ID_INSTITUCION", "ID_TIPOANTICIPO" }, cascadeDelete: true);
            AddForeignKey("dbo.RP_CUOTASANTICIPO", new[] { "ID_INSTITUCION", "NUM_ANTICIPO", "ID_EMPLEADO", "ID_TIPOANTICIPO" }, "dbo.RP_ANTICIPOS", new[] { "ID_INSTITUCION", "NUM_ANTICIPO", "ID_EMPLEADO", "ID_TIPOANTICIPO" }, cascadeDelete: true);
            AddForeignKey("dbo.RP_ABONOS", new[] { "ID_INSTITUCION", "NUM_ANTICIPO", "ID_EMPLEADO", "ID_TIPOANTICIPO" }, "dbo.RP_ANTICIPOS", new[] { "ID_INSTITUCION", "NUM_ANTICIPO", "ID_EMPLEADO", "ID_TIPOANTICIPO" }, cascadeDelete: true);
            AddForeignKey("dbo.RP_TIPOSANTICIPO", "ID_INSTITUCION", "dbo.Instituciones", "ID_INSTITUCION", cascadeDelete: true);
            AddForeignKey("dbo.RP_RUBROS", new[] { "ID_INSTITUCION", "ID_TIPOROL" }, "dbo.RP_TIPOROL", new[] { "ID_INSTITUCION", "ID_TIPOROL" }, cascadeDelete: true);
            AddForeignKey("dbo.RP_DETALLEROL", new[] { "ID_INSTITUCION", "COD_RUBRO" }, "dbo.RP_RUBROS", new[] { "ID_INSTITUCION", "COD_RUBRO" }, cascadeDelete: true);
            AddForeignKey("dbo.RP_DETALLEROL", new[] { "ID_INSTITUCION", "ID_EMPLEADO" }, "dbo.RP_EMPLEADOS", new[] { "ID_INSTITUCION", "ID_EMPLEADO" }, cascadeDelete: true);
        }
    }
}
