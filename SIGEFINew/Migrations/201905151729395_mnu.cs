    ...
    public partial class mnu : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => new { t.ID_INSTITUCION, t.PERI_CODIGO, t.CODIGO_ROL })
        ...
        public override void Down()
        {
            ...
            DropForeignKey("SIGEFI2.Mnu_Roles", new[] { "ID_INSTITUCION", "PERI_CODIGO" }, "SIGEFI2.Periodos");
            ...
            DropIndex("SIGEFI2.Mnu_Roles", new[] { "ID_INSTITUCION", "PERI_CODIGO" });
