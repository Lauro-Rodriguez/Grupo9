    ...
    public partial class Upd27 : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                .ForeignKey("dbo.PR_PROYECTOS", t => new { t.ID_INSTITUCION, t.PERI_CODIGO, t.PROG_CODIGO, t.SUBP_CODIGO, t.PROY_CODIGO }, cascadeDelete: true)
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.PR_SUBPROGRAMAS", t => new { t.ID_INSTITUCION, t.PERI_CODIGO, t.PROG_CODIGO, t.SUBP_CODIGO }, cascadeDelete: true)
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.PR_MOVGASTO", t => new { t.ID_INSTITUCION, t.PERI_CODIGO, t.NUM_TRANSAC }, cascadeDelete: true)
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.Periodos", t => new { t.ID_INSTITUCION, t.PERI_CODIGO }, cascadeDelete: true)
                .ForeignKey("dbo.PR_ACTIVIDADES", t => new { t.ID_INSTITUCION, t.PERI_CODIGO, t.PROG_CODIGO, t.SUBP_CODIGO, t.PROY_CODIGO, t.ACTI_CODIGO }, cascadeDelete: true)
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.PR_MOVINGRESO", t => new { t.ID_INSTITUCION, t.PERI_CODIGO, t.NUM_TRANSAC }, cascadeDelete: true)
                .ForeignKey("dbo.PR_PARTINGRESOS", t => new { t.ID_INSTITUCION, t.PERI_CODIGO, t.PAIN_CODIGO }, cascadeDelete: true)
                .Index(t => new { t.ID_INSTITUCION, t.PERI_CODIGO, t.NUM_TRANSAC })
